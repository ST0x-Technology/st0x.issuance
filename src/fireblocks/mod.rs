...
//! lookup, RAW hash signing, signature verification, and the legacy
//! whitelisted `CONTRACT_CALL` smoke path. The retired service-side integration
//! (the `VaultService` trait impl and mint/burn paths) is gone for good.
//!

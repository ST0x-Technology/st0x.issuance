...
let
  ...
  #      it before any deploy if the window is still open. See
  #      docs/runbooks/deploy-hold.md for the complete operator procedure.
  #
  ...
  mkIssuanceProfile =
    ...
    activate.custom pkg (
      ...
      builtins.concatStringsSep "\n" [
        ...
        # One-release cleanup for plaintext left by the retired Fireblocks key
        # activation. Idempotent and intentionally precedes all validation.
        "rm -f /run/agenix/fireblocks-secret-issuance.key"

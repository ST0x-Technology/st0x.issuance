...
Registers all 41 Robinhood Chain (4663) tokenized assets with the issuer via
...
Expect `41`. Then restart the service once and confirm it comes back up.
